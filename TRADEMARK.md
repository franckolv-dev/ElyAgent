...
The following marks are owned by **Franck OLLIVIER** (registered or pending registration with the French Industrial Property Office *INPI* and the European Union Intellectual Property Office *EUIPO*) :

| Mark | Type | Owner |
|---|---|---|
| **ELY** | Word mark | Franck OLLIVIER |
| **Éli** | Word mark (French phonetic spelling) | Franck OLLIVIER |
| **agent-ely** / **agent-ely.fr** | Word mark + domain | Franck OLLIVIER |
...
- **Build commercial integrations** that point users to install ELY themselves — your product helps them, their ELY is their ELY.
...
Forking is welcome — the project is open source for a reason. But your fork must:
...
If you want to:
- Resell, host as SaaS, or integrate ELY into a commercial product **with the name and branding intact**, OR
...
We monitor :
- The npm, PyPI, Docker Hub registries for packages using the ELY name
- GitHub for repositories that reuse the avatar / logo
- The web for unauthorized "ELY" branded products

Detected violations get a graduated response :

| Step | What happens |
|---|---|
| 1. **Friendly notice** | Email asking you to rename / remove. Most cases resolve here. |
| 2. **Cease & Desist** | Formal letter from our IP counsel. ~80% of remaining cases resolve here. |
| 3. **DMCA / hosting takedown** | We notify GitHub / Docker Hub / npm / your registrar. Content removed in 24-72h. |
| 4. **Legal action** | Trademark + license breach in commercial competition territory. Damages start at the cost of our enforcement plus your unfair profit. |

We are **not** litigious by default — we much prefer step 1. But we will use steps 2-4 when a commercial actor knowingly profits off our work.

---

## 7. Press, conferences, podcasts

If you want to write about / present ELY / interview the maintainer :
→ Email **contact@agent-ely.fr** — we will gladly send press kit (high-res screenshots, logo files, factual project info).

You may use the marks in editorial content without prior permission as long as the use is :
- **Truthful** (no false claims about features, performance, security)
- **Non-endorsing** (don't make ELY look like a partner if we're not)
- **Properly attributed** (link back to the project)

---

## 8. Questions

Anything ambiguous ? When in doubt, **ask first** — we always reply, usually within 48 hours :

📧 **contact@agent-ely.fr**
