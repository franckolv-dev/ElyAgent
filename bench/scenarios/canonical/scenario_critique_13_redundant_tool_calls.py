...
# @file       bench/scenarios/canonical/scenario_critique_13_redundant_tool_calls.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-13 (redundant_tool_calls).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-13 — Redundant tool calls."""
from __future__ import annotations


NAME = "CRIT-13 — Redundant tool calls"
DESCRIPTION = 'completed mission, score 55, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Donner la météo de demain à Lyon'
...
_MAIN_ISSUE = 'appelle trois fois le même outil de lecture pour la même donnée'
