...
# @file       bench/scenarios/canonical/scenario_critique_09_misread_eval.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-09 (misread_eval).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-09 — Misread eval."""
from __future__ import annotations


NAME = "CRIT-09 — Misread eval"
DESCRIPTION = 'failed mission, score 33, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Vérifier que la sauvegarde nocturne a réussi'
...
_MAIN_ISSUE = "évalue 'succès' une étape dont le tool_output était une erreur 500"
