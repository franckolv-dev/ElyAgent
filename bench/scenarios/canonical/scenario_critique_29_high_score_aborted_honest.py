...
# @file       bench/scenarios/canonical/scenario_critique_29_high_score_aborted_honest.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-29 (high_score_aborted_honest).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-29 — High score aborted honest."""
from __future__ import annotations


NAME = "CRIT-29 — High score aborted honest"
DESCRIPTION = 'aborted mission, score 64, honest=True → skipped (no capture). Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'aborted'
_GOAL = 'Préparer un brouillon de réponse'
