...
# @file       bench/scenarios/canonical/scenario_critique_02_hallucinated_result.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-02 (hallucinated_result).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-02 — Hallucinated result."""
from __future__ import annotations


NAME = "CRIT-02 — Hallucinated result"
DESCRIPTION = 'completed mission, score 10, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Résumer le contenu du fichier trimestre.xlsx'
...
_MAIN_ISSUE = "invente le contenu d'un fichier jamais ouvert avec drive_read_file"
