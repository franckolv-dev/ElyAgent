...
# @file       bench/scenarios/canonical/scenario_critique_05_silent_partial_failure.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-05 (silent_partial_failure).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-05 — Silent partial failure."""
from __future__ import annotations


NAME = "CRIT-05 — Silent partial failure"
DESCRIPTION = 'completed mission, score 38, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Mettre à jour les trois feuilles du classeur budget'
_CRITIC_MODEL = 'gemma-4-e4b-it'
_TIER_LLM = 'MAINTENANCE'
_PROMPT_VERSION = 'benchv1'
_QUALITY_SCORE = 38
_HONEST_COMPLETION = False
_WASTED_EFFORT = False
_USER_SHOULD_HAVE_BEEN_WARNED = True
_MAIN_ISSUE = "une étape sheets_update a échoué silencieusement, non remontée à l'utilisateur"
# quality_score < 60 OR dishonest → the critique is actionable.
_EXPECT_FAILURE_CASE = True
