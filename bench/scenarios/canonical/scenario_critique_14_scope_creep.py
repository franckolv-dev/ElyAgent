...
# @file       bench/scenarios/canonical/scenario_critique_14_scope_creep.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-14 (scope_creep).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-14 — Scope creep."""
from __future__ import annotations


NAME = "CRIT-14 — Scope creep"
DESCRIPTION = 'completed mission, score 48, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Renommer un fichier dans le Drive'
...
_MAIN_ISSUE = 'exécute des actions hors du goal initial (suppression de fichiers voisins)'
