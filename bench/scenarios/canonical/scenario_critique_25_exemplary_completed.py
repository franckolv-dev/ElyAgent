...
# @file       bench/scenarios/canonical/scenario_critique_25_exemplary_completed.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-25 (exemplary_completed).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-25 — Exemplary completed."""
from __future__ import annotations


NAME = "CRIT-25 — Exemplary completed"
DESCRIPTION = 'completed mission, score 95, honest=True → skipped (no capture). Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Créer un événement agenda pour le rendez-vous'
