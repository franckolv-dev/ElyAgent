...
# @file       bench/scenarios/canonical/scenario_critique_21_hitl_stuck_timeout.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-21 (hitl_stuck_timeout).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-21 — Hitl stuck timeout."""
from __future__ import annotations


NAME = "CRIT-21 — Hitl stuck timeout"
DESCRIPTION = 'aborted mission, score 22, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'aborted'
_GOAL = 'Supprimer définitivement les mails de la corbeille'
...
_MAIN_ISSUE = "bloqué en hitl_wait, l'utilisateur n'a jamais répondu à la confirmation"
