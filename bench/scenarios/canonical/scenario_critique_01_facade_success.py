...
# @file       bench/scenarios/canonical/scenario_critique_01_facade_success.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-01 (facade_success).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-01 — Facade success."""
from __future__ import annotations


NAME = "CRIT-01 — Facade success"
DESCRIPTION = 'completed mission, score 20, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = "Envoyer le compte-rendu de réunion à l'équipe"
...
_MAIN_ISSUE = 'prétend avoir envoyé le mail mais aucun appel gmail_send_email dans la trace'
