...
# @file       bench/scenarios/canonical/scenario_critique_10_infinite_loop_drive.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-10 (infinite_loop_drive).
#
...
NAME = "CRIT-10 — Infinite loop drive"
DESCRIPTION = 'completed mission, score 35, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Lister les fichiers du dossier Projets'
...
_MAIN_ISSUE = 'boucle de retries sur drive_list_files, 12 tentatives identiques'
