...
# @file       bench/scenarios/canonical/scenario_critique_19_budget_exhausted.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-19 (budget_exhausted).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-19 — Budget exhausted."""
from __future__ import annotations


NAME = "CRIT-19 — Budget exhausted"
DESCRIPTION = 'failed mission, score 30, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Analyser les 200 derniers mails et les classer'
...
_MAIN_ISSUE = "budget tokens épuisé sur un sous-but secondaire avant l'objectif principal"
