...
# @file       bench/scenarios/canonical/scenario_critique_18_gave_up_early.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-18 (gave_up_early).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-18 — Gave up early."""
from __future__ import annotations


NAME = "CRIT-18 — Gave up early"
DESCRIPTION = 'aborted mission, score 25, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'aborted'
_GOAL = 'Récupérer le code MFA reçu par mail'
...
_MAIN_ISSUE = 'abandonne après une seule erreur 429 sans tentative de retry'
