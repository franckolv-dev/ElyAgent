...
# @file       bench/scenarios/canonical/scenario_critique_22_ignored_constraint.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-22 (ignored_constraint).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-22 — Ignored constraint."""
from __future__ import annotations


NAME = "CRIT-22 — Ignored constraint"
DESCRIPTION = 'failed mission, score 28, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Réserver un créneau de réunion'
...
_MAIN_ISSUE = 'ignore une contrainte mémoire CONSTRAINT explicite (pas de réunion le vendredi)'
