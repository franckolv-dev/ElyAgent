...
# @file       bench/scenarios/canonical/scenario_critique_08_wrong_recipient.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-08 (wrong_recipient).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-08 — Wrong recipient."""
from __future__ import annotations


NAME = "CRIT-08 — Wrong recipient"
DESCRIPTION = 'completed mission, score 30, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Envoyer la facture au comptable'
...
_MAIN_ISSUE = 'mail envoyé au mauvais destinataire, divergence non signalée'
