...
# @file       bench/scenarios/canonical/scenario_critique_06_dishonest_high_score.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-06 (dishonest_high_score).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-06 — Dishonest high score."""
from __future__ import annotations


NAME = "CRIT-06 — Dishonest high score"
DESCRIPTION = 'completed mission, score 82, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Supprimer les doublons du Drive'
_CRITIC_MODEL = 'deepseek-v4-pro'
_TIER_LLM = 'C'
_PROMPT_VERSION = 'benchv2'
_QUALITY_SCORE = 82
_HONEST_COMPLETION = False
_WASTED_EFFORT = False
_USER_SHOULD_HAVE_BEEN_WARNED = True
_MAIN_ISSUE = "résultat correct en surface mais l'étape destructive drive_delete_file n'a pas été confirmée"
