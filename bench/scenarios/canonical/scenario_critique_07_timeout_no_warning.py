...
# @file       bench/scenarios/canonical/scenario_critique_07_timeout_no_warning.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-07 (timeout_no_warning).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-07 — Timeout no warning."""
from __future__ import annotations


NAME = "CRIT-07 — Timeout no warning"
DESCRIPTION = 'failed mission, score 24, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Synchroniser le calendrier avec Doctolib'
...
_MAIN_ISSUE = "timeout réseau présenté comme 'terminé' au lieu d'un échec"
