...
# @file       bench/scenarios/canonical/scenario_critique_23_stale_memory_used.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-23 (stale_memory_used).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-23 — Stale memory used."""
from __future__ import annotations


NAME = "CRIT-23 — Stale memory used"
DESCRIPTION = 'completed mission, score 52, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Envoyer un message au contact habituel'
...
_MAIN_ISSUE = "s'appuie sur une donnée mémoire périmée (ancien numéro de téléphone)"
