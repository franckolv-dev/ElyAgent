...
# @file       bench/scenarios/canonical/scenario_critique_16_wrong_args_excel.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-16 (wrong_args_excel).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-16 — Wrong args excel."""
from __future__ import annotations


NAME = "CRIT-16 — Wrong args excel"
DESCRIPTION = 'completed mission, score 45, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Additionner la colonne des montants'
...
_MAIN_ISSUE = 'mauvaise plage de colonnes passée à sheets_update_range'
