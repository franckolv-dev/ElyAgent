...
# @file       bench/scenarios/canonical/scenario_critique_17_format_ignored.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-17 (format_ignored).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-17 — Format ignored."""
from __future__ import annotations


NAME = "CRIT-17 — Format ignored"
DESCRIPTION = 'completed mission, score 44, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Exporter la liste des contacts en CSV'
...
_MAIN_ISSUE = 'ignore le format de sortie demandé (tableau markdown au lieu de CSV)'
