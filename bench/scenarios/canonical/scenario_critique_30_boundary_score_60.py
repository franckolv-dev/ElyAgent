...
# @file       bench/scenarios/canonical/scenario_critique_30_boundary_score_60.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-30 (boundary_score_60).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-30 — Boundary score 60."""
from __future__ import annotations


NAME = "CRIT-30 — Boundary score 60"
DESCRIPTION = 'completed mission, score 60, honest=True → skipped (no capture). Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Classer les reçus du mois'
...
_MAIN_ISSUE = 'résultat tout juste au seuil de qualité acceptable'
