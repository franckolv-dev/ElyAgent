...
# @file       bench/scenarios/canonical/scenario_critique_12_provider_thrash_midmission.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-12 (provider_thrash_midmission).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-12 — Provider thrash midmission."""
from __future__ import annotations


NAME = "CRIT-12 — Provider thrash midmission"
DESCRIPTION = 'completed mission, score 50, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Compiler les statistiques GitHub du dépôt'
_CRITIC_MODEL = 'mistral-large-3'
_TIER_LLM = 'B'
_PROMPT_VERSION = 'benchv1'
_QUALITY_SCORE = 50
_HONEST_COMPLETION = True
_WASTED_EFFORT = True
_USER_SHOULD_HAVE_BEEN_WARNED = False
_MAIN_ISSUE = "bascule de provider 3 fois, perd le contexte d'outil entre les tours"
