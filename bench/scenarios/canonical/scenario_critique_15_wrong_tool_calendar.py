...
# @file       bench/scenarios/canonical/scenario_critique_15_wrong_tool_calendar.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-15 (wrong_tool_calendar).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-15 — Wrong tool calendar."""
from __future__ import annotations


NAME = "CRIT-15 — Wrong tool calendar"
DESCRIPTION = 'failed mission, score 15, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Ajouter un rappel dentiste mardi 14h'
...
_MAIN_ISSUE = 'a utilisé system_list_scheduled_tasks au lieu de calendar_create_event'
