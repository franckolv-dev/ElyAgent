...
# @file       bench/scenarios/canonical/scenario_critique_20_cascade_tool_error.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-20 (cascade_tool_error).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-20 — Cascade tool error."""
from __future__ import annotations


NAME = "CRIT-20 — Cascade tool error"
DESCRIPTION = 'aborted mission, score 12, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'aborted'
_GOAL = 'Publier le post sur les réseaux'
...
_MAIN_ISSUE = 'erreur outil en chaîne, abandon propre mais aucun résultat livré'
