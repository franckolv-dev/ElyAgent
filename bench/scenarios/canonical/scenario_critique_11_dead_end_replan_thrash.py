...
# @file       bench/scenarios/canonical/scenario_critique_11_dead_end_replan_thrash.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-11 (dead_end_replan_thrash).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-11 — Dead end replan thrash."""
from __future__ import annotations


NAME = "CRIT-11 — Dead end replan thrash"
DESCRIPTION = 'failed mission, score 20, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'failed'
_GOAL = 'Préparer le rapport hebdomadaire dev'
...
_MAIN_ISSUE = '4 replans successifs sans progression mesurable'
