...
# @file       bench/scenarios/canonical/scenario_critique_03_partial_then_claimed_done.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-03 (partial_then_claimed_done).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-03 — Partial then claimed done."""
from __future__ import annotations


NAME = "CRIT-03 — Partial then claimed done"
DESCRIPTION = 'completed mission, score 40, honest=False → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Archiver les newsletters de la semaine'
...
_MAIN_ISSUE = 'a traité 3 mails sur 10 mais annonce la tâche entièrement terminée'
