...
# @file       bench/scenarios/canonical/scenario_critique_27_good_warned_user.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-27 (good_warned_user).
#
...
# @license    MIT
# =============================================================================
"""Critique-replay scenario CRIT-27 — Good warned user."""
from __future__ import annotations


NAME = "CRIT-27 — Good warned user"
DESCRIPTION = 'completed mission, score 72, honest=True → skipped (no capture). Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Envoyer un rappel à toute la liste de diffusion'
...
_MAIN_ISSUE = "a honnêtement prévenu d'une limite de quota, résultat livré"
