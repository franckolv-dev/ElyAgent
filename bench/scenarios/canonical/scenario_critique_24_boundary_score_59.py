...
# @file       bench/scenarios/canonical/scenario_critique_24_boundary_score_59.py
# @brief      Sprint 3.7.3 J2 — critique-replay scenario CRIT-24 (boundary_score_59).
#
...
# =============================================================================
"""Critique-replay scenario CRIT-24 — Boundary score 59."""
from __future__ import annotations


NAME = "CRIT-24 — Boundary score 59"
DESCRIPTION = 'completed mission, score 59, honest=True → FailureCase. Asserts the capture filter, stable pattern_hash, and learning-report round-trip.'
TAGS = ["shallow"]

# ── Frozen verdict profile ──────────────────────────────────────────────
_STATUS = 'completed'
_GOAL = 'Trier les photos du dossier vacances'
...
_MAIN_ISSUE = 'résultat juste en dessous du seuil de qualité acceptable'
